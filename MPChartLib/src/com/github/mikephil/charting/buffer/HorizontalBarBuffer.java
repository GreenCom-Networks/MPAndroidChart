...
public class HorizontalBarBuffer extends BarBuffer {
    ...
    public HorizontalBarBuffer(int size, float groupspace, int dataSetCount, boolean containsStacks, boolean allowSuperposition) {
        super(size, groupspace, dataSetCount, containsStacks, allowSuperposition);
    }
